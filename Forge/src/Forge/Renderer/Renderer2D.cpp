...
namespace Forge {
	...
	void Renderer2D::DrawQuad(const glm::vec3& pos, const glm::vec2 size, const Ref<SubTextures2D>& subTexture) {
		FG_PROFILE_FUNCTION();
	...
	void Renderer2D::DrawQuad(const glm::vec2& pos, const glm::vec2 size, const Ref<SubTextures2D>& subTexture) {
		Renderer2D::DrawQuad(glm::vec3(pos, 0.0f), size, subTexture);
	}
